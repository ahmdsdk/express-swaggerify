...
### Changed
- 🕒 Added generation timestamp comment to generated Swagger docs for easier debugging
- 🧠 Improved TypeScript type extraction handling for arrays and unions to avoid incorrect array schemas
